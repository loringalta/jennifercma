/*! gridster.js - v0.5.4 - 2014-07-16 - * http://gridster.net/ - Copyright (c) 2014 ducksboard; Licensed MIT */ ! function (a, b) {
...
function (a, b) {
    ...
    function b(b, d) {
        this.options = a.extend({}, c, d), this.$document = a(document), this.$container = a(b), this.$dragitems = a(this.options.items, this.$container), this.is_dragging = !1, this.player_min_left = 0 + this.options.offset_left, this.init()
    }
    var c = {
            items: "li",
            distance: 1,
    ...
    return i.init = function () {
        ...
        this.calculate_dimensions(), this.$container.css("position", "static" === b ? "relative" : b), this.disabled = !1, this.events(), a(window).bind("resize.gridster-draggable", throttle(a.proxy(this.calculate_dimensions, this), 200))
    }, i.events = function () {
        this.$container.on("selectstart.gridster-draggable", a.proxy(this.on_select_start, this)), this.$container.on(g.start, this.options.items, a.proxy(this.drag_handler, this)), this.$document.on(g.end, a.proxy(function (a) {
        ...
        b.preventDefault();
        var c = this.get_mouse_pos(b),
            d = Math.round(c.left - this.mouse_init_pos.left),
            e = Math.round(c.top - this.mouse_init_pos.top),
            f = Math.round(this.el_init_offset.left + d - this.baseX + a(window).scrollLeft() - this.win_offset_x),
            g = Math.round(this.el_init_offset.top + e - this.baseY + a(window).scrollTop() - this.win_offset_y);
        ...
        var f, g = e[b],
            ...
            m = k ? a(document).width() : a(document).height(),
            ...
            t = p + c.pointer[g],
            u = m - l + n;
        return t >= r && (f = o + j, u > f && (d["scroll" + h(g)](f), this["scroll_offset_" + b] += j)), s >= t && (f = o - j, f > 0 && (d["scroll" + h(g)](f), this["scroll_offset_" + b] -= j)), this
        ...
        if (!this.disabled && (1 === b.which || f) && !this.ignore_drag(b)) {
            var c = this,
                d = !0;
            return this.$player = a(b.currentTarget), this.el_init_pos = this.get_actual_pos(this.$player), this.mouse_init_pos = this.get_mouse_pos(b), this.offsetY = this.mouse_init_pos.top - this.el_init_pos.top, this.$document.on(g.move, function (a) {
        ...
        this.disable(), this.$container.off(".gridster-draggable"), this.$document.off(".gridster-draggable"), a(window).off(".gridster-draggable"), a.removeData(this.$container, "drag")
...
function (a, b) {
    ...
    return e.init = function () {
        ...
        var c = b instanceof jQuery,
            d = c ? this.dom_to_coords(b) : b;
        c || (b = d.el);
        var e = this.can_go_widget_up(d);
        return e && (d.row = e, b.attr("data-row", e), this.$el.trigger("gridster:positionchanged", [d])), this.options.avoid_overlapped_widgets && !this.can_move_to({
            size_x: d.size_x,
            size_y: d.size_y
            ...
            "data-sizex": d.size_x,
            "data-sizey": d.size_y
        })), b.data("coords", b.coords()), b.data("coords").grid = d, this.add_to_gridmap(d, b), this.options.resize.enabled && this.add_resize_handle(b), !!e
        ...
        var c, d = b.pointer.diff_left,
            ...
            f = this.options.widget_base_dimensions[0],
            ...
            n = this.options.autogrow_cols,
            o = 1 / 0,
            p = 1 / 0,
            q = Math.ceil(d / (f + 2 * h) - .2),
            r = Math.ceil(e / (g + 2 * i) - .2),
        ...
        var d = this,
            e = b.coords().grid,
            f = (c - e.row, this.widgets_below(b)),
            g = this.can_move_to(e, e.col, c, b);
        ...
        var d = a.isPlainObject(b) ? b : b.coords().grid,
            e = this,
            f = (this.gridmap, d.row + d.size_y - 1),
            g = a([]);
        ...
        var d, e = "",
            f = this.options.max_size_x || this.cols;
        ...
        var b = c.generated_stylesheets,
            d = this.generated_stylesheets;
        ...
        for (var b = this.rows, c = b + (a || 1), d = c; d > b; d--)
        ...
        var b = this.$wrapper.width(),
            c = this.options.max_cols,
            d = Math.floor(b / this.min_widget_width) + this.options.extra_cols,
